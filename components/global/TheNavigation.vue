    ...
    <div class="container flex flex-wrap items-center lg:flex-no-wrap">
      ...
      >
        ...
        <span
          ...
          :class="{ '-rotate-45 absolute right-0':mobileNavOpen}"
        ></span>
        <span class="bg-blue-500 h-1 w-8 rounded mb-1" :class="{ 'hidden':mobileNavOpen}"></span>
      </a>
      <div class="w-full flex" :class="{ 'mt-8': mobileNavOpen, 'hidden lg:flex': !mobileNavOpen }">
        <ul class="lg:h-24 lg:flex items-center w-full lg:w-auto">
          <li>
            <nuxt-link :to="{ name: 'home' }" class="text-lg text-gray-700 lg:py-8 lg:px-4">Browse</nuxt-link>
          </li>
          <li>
            <nuxt-link :to="{ name: 'home' }" class="text-lg text-gray-700 lg:py-8 lg:px-4">Search</nuxt-link>
          </li>
        </ul>
